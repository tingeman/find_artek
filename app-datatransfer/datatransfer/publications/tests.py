...
class TestPublicationData(unittest.TestCase):
   ...
   # find all appendencis associated with a publication
    ...
    def test_get_publications_on_topic(self):
        ...
        len_expected_publication_titles = len(expected_publication_titles)
        if len_publications != len_expected_publication_titles:
            raise AssertionError("Number of publications does not match the expected number of publication titles.")

        self.assertEqual(len_publications, len_expected_publication_titles)

        # for i, publication in enumerate(publications):
        #     with self.subTest(i=i):
        #         expected_publication_title = expected_publication_titles[i]
        #         publication_title = publication.title
        #         self.assertEqual(publication_title, expected_publication_title) 
