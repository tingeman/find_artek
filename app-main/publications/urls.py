...
urlpatterns = [
    ...
    path('report/<int:pub_id>/verify/', views.VerifyReportView.as_view(), name='verify_report'),
    path('report/<int:pub_id>/unverify/', views.UnverifyReportView.as_view(), name='unverify_report'),
